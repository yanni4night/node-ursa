...
module.exports = function(project, compress, html) {
   ...
   // execSync("rm -rf ./build/static/js"); //先删除，等后续生成必要文件时才创建
    ...
    removeUseless("./build/static/css",/\.css$/i);
    removeUseless("./build/static/js",/\.js$/i);
