        ...
        async.each(htmlFiles, function(file, callback) {
            ...
            async.series([
                ...
                function(callback) {
                    ...
                    content = filter(content, project);
                    //2013-11-24[01:01:30]
                    content=content.replace(/<!--[\s\S]*?@require[\s\S]*?-->/,'');
                    callback();
                },
                //写入文件
                function(callback) {
    ...
    module.exports = function(project, compress, html) {
        ...
        g_requireOptimizeProject&&console.log("[INFO]Using r.js-project-optimize".info);
        ...
        async.series([
            ...
            console.log("[TIP]Issues:https://github.com/yanni4night/node-ursa/issues".info);
        });
