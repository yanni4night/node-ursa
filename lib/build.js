 ...
 */
    ...
    module.exports = function(project, compress, html) {
        ...
        //顺序很重要：先压缩静态文件
            ...
            makeCss(project, compress, function(err) {
                makeJs(project, compress, function(err) {
                    makeTpl(project, function(err) {
                        html && makeHtml(project, function() {
